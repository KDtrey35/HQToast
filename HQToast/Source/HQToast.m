...
- (instancetype)init
{
    ...
    if (self) {
        ...
        timer = [NSTimer scheduledTimerWithTimeInterval:1.5 target:self selector:@selector(changeTimeCount) userInfo:nil repeats:YES];
...
- (void)showText:(NSString *)text
{
    ...
    [self setToastText:text Duration:1.0 CornerRadiusNum:4.0 LabelBackColor:[UIColor blackColor] LabelFont:[UIFont systemFontOfSize:14] LabelColor:[UIColor whiteColor] LabelFrame:CGPointMake(0, 0)];
}
